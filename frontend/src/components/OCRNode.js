...
export default function OCRNode({ data, selected, id }) {
  return (
    <div
      ...
      className={`bg-primary border ${selected ? "border-teal-400 shadow-[0_0_15px_rgba(45,212,191,0.4)]" : "border-neutral-700 shadow-md"} rounded-xl min-w-[200px] overflow-hidden transition-all relative`}
      style={{ direction: "rtl" }}
    >
