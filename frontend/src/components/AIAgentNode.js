...
export default function AIAgentNode({ data, selected, id }) {
  return (
    <div
      ...
      className={`bg-neutral-900 border ${selected ? "border-purple-400 shadow-[0_0_15px_rgba(168,85,247,0.4)]" : "border-neutral-700 shadow-md"} rounded-xl min-w-[200px] overflow-hidden transition-all relative`}
      style={{ direction: "rtl" }}
    >
