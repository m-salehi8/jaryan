...
این سند طراحی فنی برای شش فیچر MVP پلتفرم «راهکار» را پوشش می‌دهد. تمام تغییرات با معماری موجود (FastAPI + Motor + React/CRA) سازگارند و نیازی به dependency جدید ندارند.
