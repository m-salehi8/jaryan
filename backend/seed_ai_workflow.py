...
async def seed_ai_workflow():
    ...
    wf = Workflow(
        ...
        nodes=[
            ...
            WorkflowNode(
                ...
                data={"expression": "ai_evaluation.approved == true"},
            ),
            WorkflowNode(
                id="n5",
                type="approval",
    ...
    wf.edges[3].condition = {
        "field_id": "ai_evaluation.approved",
        "op": "=",
        "value": "true",
    }
